...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index_hrd.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="page-custom/hrd_data_karyawan.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="page-custom/hrd_daily.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="page-custom/hrd_gaji.php" class="nav-link">
